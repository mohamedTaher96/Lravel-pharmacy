...
<section class="content">
        <div class="box">
                <div class="box-header">
                  <h3 class="box-title">  Category : </h3><span class="item"> {{$makeup->name}}</span> <br><br>
                  <a href="http://localhost:8000/admin/makeup/item/new?id={{$id}}" role="button" class="btn btn-primary" >Add Packet </a>
                </div><!-- /.box-header -->
