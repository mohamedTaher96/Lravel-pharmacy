...
route::post('/admin/company/bill/add','adminController@addCompanyBill');
...
route::post('/admin/store/bill/add','adminController@addStoreBill');
...
route::post('/admin/medicine/item/add','adminController@addItem');
...
route::post('/admin/makeup/item/add','adminController@addMakeupItem');
